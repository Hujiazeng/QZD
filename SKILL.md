...
1. extract_text — 提取文案
2. rewrite_text — 改写文案
3. generate_voice — 生成语音
4. generate_video — 生成数字人视频
5. create_subtitle — 生成字幕
6. add_subtitle — 添加字幕到视频
7. add_bgm — 添加背景音乐
8. generate_cover — 生成封面
9. generate_title_tags — 生成标题标签
10. publish — 发布

或者直接使用 execute_all 一键完成步骤 2-9。
